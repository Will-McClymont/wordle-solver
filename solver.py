...
class WordleSolver():
    ...
    def __init__(self,
        ...
        self.setTrueWord(true_word)

    def setTrueWord(self, true_word):
        '''
    ...
    def fetchWordList(self):
        ...
        self.wordlist_num_letters = np.zeros((len(self.master_wordlist), 26),
                                             dtype=int)
    ...
    def processGuess(self, guess):
        ...
        self.eliminateNonViableWords()

        return False

    def eliminateNonViableWords(self):
